...
<head>
  ...
  <link rel="shortcut icon" href="css/icons8-calendario-16.png" type="image/x-icon">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-2">
        ...
        <hr>
        <button type="button" id="BotonEventosPredefinidos" class="btn btn-success button-send">Administrar eventos predefinidos</button>
      </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="color" value="#3788D8" id="ColorFondo" class="form-control">
          </div>
          <div class="form-group">
            <label>Color de texto:</label>
            <input type="color" value="#ffffff" id="ColorTexto" class="form-control">
          </div>
